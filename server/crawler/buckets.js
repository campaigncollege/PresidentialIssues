...
var persistentBuckets = {};

console.log(buckets.BSTree);

var bucketsFunctions = Object.keys(buckets);

for(var i=0; i<bucketsFunctions.length; i++){
    //console.log(bucketsFunctions[i]);
    var curr = bucketsFunctions[i];
    
    persistentBuckets[bucketsFunctions[i]] = function(){
        console.log(curr);
        var ret = buckets.curr.apply(this,arguments);
        console.log("Called!");
        return ret;
    }
}

console.log(persistentBuckets);

exports.buckets = persistentBuckets;
